...
export class ApprovalsController {
  ...
  @swagger.ApiCreatedResponse({ type: Approvals })
  @swagger.ApiForbiddenResponse({ type: errors.ForbiddenException })
  async create(
    @common.Query() query: {},
    @common.Body() data: ApprovalsCreateInput,
  ...
  @swagger.ApiOkResponse({ type: [Approvals] })
  ...
  async findOne(
    @common.Query() query: {},
    @common.Param() params: ApprovalsWhereUniqueInput,
    @nestAccessControl.UserRoles() userRoles: string[]
